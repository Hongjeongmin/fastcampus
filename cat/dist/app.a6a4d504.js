  ...
  _createClass(AppView, [{
    ...
    value: function render(id) {
      ...
      api.getData(function (data) {
        _this2.nodes = _this2.store.nodes = data;

        _this2.setTemplateData('routers', _this2.createRouterHTML());

        _this2.setTemplateData('nodes', _this2.createNodeHTML());
...
},{"./app-view.js":"src/page/app-view.js"}],"src/app.js":[function(require,module,exports) {
"use strict";
...
var appView = new _index.AppView('app', store); // init

store.pushRouters('root');
appView.render('');
},{"./store.js":"src/store.js","./page/index.js":"src/page/index.js"}],"../../../../.nvm/versions/node/v16.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.nvm/versions/node/v16.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.js"], null)
